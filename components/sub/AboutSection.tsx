    ...
    return (
        ...
        >
            ...
            >
                ...
                </motion.p><motion.p className="text-white text-xl !max-w-[90%] text-justify mb-3">
                    Beyond the academic realm, my proactive involvement in coordinating tech events is a testament to my organizational skills. As a Co-Coordinator of Prajwalan'23 and a member of the GCOEA Core-Team, I've orchestrated successful events aimed at promoting education and student development.
                </motion.p><motion.p className=" text-white text-xl !max-w-[90%] text-justify mb-3">
